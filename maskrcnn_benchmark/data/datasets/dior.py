...
class DIORDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, transforms=None, is_source= False):
        ...
        self._imgpath = os.path.join(self.root, "AllImages", "%s.jpg")
        self.ids = []
        cls = DIORDataset.CLASSES
        self.class_to_ind = dict(zip(cls, range(len(cls))))
        for x in os.listdir(os.path.join(self.root, "AllImages")):
    ...
    def map_class_id_to_class_name(self, class_id):
        return DIORDataset.CLASSES[class_id]
