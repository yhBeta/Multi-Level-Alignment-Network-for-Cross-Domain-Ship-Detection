...
class DALossComputation(object):
    ...
    def __call__(self, da_img, da_ins, da_img_consist, da_ins_consist, da_ins_labels, targets):
        ...
        """
        # for i in range(len(da_img)):
        #     print(da_img[i].shape, end=' ')
        # print()
        # for i in range(len(da_img_consist)):
        #     print(da_img[i].shape, end=' ')
        # print()
        # print(da_ins.shape, da_ins_consist.shape, da_ins_labels.shape)
        ...
        print('da_image: {}, da_image_label: {}'.format(da_img_flattened.shape, torch.sum(da_img_labels_flattened[1])))
