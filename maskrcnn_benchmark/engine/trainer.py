...
def do_da_train(
    ...
    for iteration, ((source_images, source_targets, idx1), (target_images, target_targets, idx2)) in enumerate(
        ...
        # loss_dict = model(images, targets)
        # torchsummary.summary(model.cuda(), [images, source_images.to(device), target_images.to(device), targets])
        # print('parameters_count:', count_parameters(model))
        loss_dict = model(images, source_images.to(device), target_images.to(device), targets)
